      ...
      >
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <br/> 
            例如：用户搜索“历史类 550分”，网站会将2020年公示的所有的[录取最高名次，录取最低名次]区间包括550分对应排名的文史类录取信息（院校）展示给用户
            <br/>
            请注意：展示出的信息仅仅代表“该院校在2020年重庆市该类别该批次的排位区间”与用户搜索的分数排位产生交集，网站不保证与2021年度录取有关的任何事宜
            <br/>
